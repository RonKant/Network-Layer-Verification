...
void hashMapTests(){
    ...
    //ID6 for socket6:
    SocketID socket6ID= xmalloc(sizeof(*socket6ID));
    assume(socket6ID != socket1ID);
    assume(socket6ID != socket3ID);
    assume(socket6ID != socket4ID);
    assume(socket6ID != socket5ID);
    strcpy_t(socket6ID->src_ip,"192.168.1.252");
    strcpy_t(socket6ID->dst_ip,"192.168.1.254");
    socket6ID->src_port = socket1ID->src_port;
    socket6ID->dst_port = socket1ID->dst_port;
    ...
    //creation of socket6:
    Socket socket6 = create_new_socket();
    assume(socket6 != socket1);
    assume(socket6 != socket3);
    assume(socket6 != socket4);
    socket6->id = socket6ID;
    sassert(compareKeys(socket6->id,socket6ID) ==true);
    assume(socket6->id == socket6ID);
    ...
    if(hash_map1->ghost_v == socket6){
        assume(hash_map1->ghost_has_v == 0);
    }

    assume(compareKeys(socket1ID,socket4ID) ==false);
    assume(compareKeys(socket1ID,socket3ID) ==false);
    assume(compareKeys(socket1ID,socket5ID) ==false);
    assume(compareKeys(socket3ID,socket4ID) ==false);
    assume(compareKeys(socket3ID,socket5ID) ==false);
    assume(compareKeys(socket4ID,socket5ID) ==false);
    ...
    //insertion of the forth socket
    bool value4 = insertSocket(hash_map1,socket6);
    assume(value4 == false);
    sassert(getHashMapNumberOfSockets(hash_map1) == 3);
